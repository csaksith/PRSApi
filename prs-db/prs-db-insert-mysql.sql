...
VALUES 
(1, 'R2502240001', 'Gel Polish Restock', 'Need more gel polish for upcoming appointments', '2025-02-28', 'Mail', 'NEW', 0.0, NOW(), NULL),
(2, 'R2502240002', 'New Acrylic Powders', 'Running low on clear acrylic for nail extensions', '2025-03-01', 'Pickup', 'NEW', 0.0, NOW(), NULL),
(3, 'R2502240003', 'Essential Tools Order', 'Need files and buffers for clients', '2025-02-27', 'Mail', 'NEW', 0.0, NOW(), NULL);
